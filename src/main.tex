...
\parskip = 0.85\baselineskip % paragraph gap: one baseline for clearer separation
...
\fancyhead[L]{%
  \fontsize{5}{11}\selectfont\fontseries{l}\selectfont% Light weight, smaller font
  \leftmark%
}
\fancyhead[C]{%
  \fontsize{5}{10}\selectfont\fontseries{l}\selectfont% Extra light, smaller
  \rightmark%
}
\fancyhead[R]{%
...
% =============================================================================
% 0) Front Matter (Pages 1-3)
% =============================================================================
\input{TeXFiles/010_ExecutiveSummary}
% \input{TeXFiles/004_LaTeXHowTo}      %%%%%% <<<<<< LaTeX How-To Guide (keep as reference)

% =============================================================================
% 1) Organization Profile & Internship Setup (Pages 4-7)
% =============================================================================
\input{TeXFiles/020_OrganizationProfile}

% =============================================================================
% 2) Engineering Method (Pages 8-10)
% =============================================================================
\input{TeXFiles/030_EngineeringMethod}

% =============================================================================
% TRACK A — Workflow Automation & Infra R&D (Pages 11-26)
% =============================================================================

% 3) Track A Overview (Pages 11-12)
\input{TeXFiles/035_TrackAOverview}

% 4) ERP Integration via n8n (Pages 13-17)
\input{TeXFiles/051_Task1_n8nIntegration}

% 5) Local Model Serving & Enterprise Options (Pages 18-22)
\input{TeXFiles/052_Task2_ModelServing}

% 5.5) RAG Deployment for Product Q&A
\input{TeXFiles/053_Task3_RAGDeployment}

% 6) MCP Exploration (Pages 23-26)
\input{TeXFiles/055_MCPExploration}

% =============================================================================
% TRACK B — LangGraph Agent Platform Engineering (Pages 27-48)
% =============================================================================

% 7) Track B Overview: Agent Platform Goals & Requirements (Pages 27-29)
\input{TeXFiles/040_TrackBOverview}

% 8-9) LangGraph Industrial Architecture + Graph Design (Pages 30-43)
\input{TeXFiles/050_LangGraphArchitecture}

% 10-11) Governance & Observability + CI/CD & Operations (Pages 44-48)
\input{TeXFiles/060_GovernanceCICD}

% =============================================================================
% 12) Results, Skills, Lessons, and Personal Commentary (Pages 49-50)
% =============================================================================
\input{TeXFiles/070_Results}

% Conclusion + References
\input{TeXFiles/080_Conclusion}

\appendix
\input{TeXFiles/090_Appendix}
