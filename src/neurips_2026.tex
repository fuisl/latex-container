...
% §2.1 ND-POMDP and the coordination graph
%   Three TSC-specific motivating attributes:
%   (a) reward locality: r = Σ_i r_i + Σ_{(i,j)∈G_C} r_ij  (spill-back interaction terms)
%   (b) tractability: joint action space O(|A|^ω), ω = max clique size in G_C
%   (c) G_C is a free design variable; InfoMap supplies the principled answer
% §2.2 Map equation: L(M) = q·H(Q) + Σ p_k·H(P_k); no resolution limit
\textbf{[To be written — Step 4]}
