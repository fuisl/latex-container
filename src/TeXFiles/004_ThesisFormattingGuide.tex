...
Hello, we are currently in section \ref{sec:LateXHowTo_TestSektion}, or more precisely in
subsection \ref{sec:LateXHowTo_Testsubsektion} ...
...
Literatur zitiert man so: \citep{varaiya2013max}. Sobald man eine Literaturreferenz zitiert,
wird diese automatisch
in die Bibliographie eingetragen. Referenzierung von Web-Seiten ist auch moeglich, wie in \citep{wandb} gezeigt.
