...
\ifdefstring{\CompanyName}{NoCompanyInvolved}{}{
    \ifdefined\ThesisLanguageIsEnglish
        ...
        \thispagestyle{empty}
        This practical training report contains information of the company \CompanyName. The disclosure or
        unauthorized use of this report as a whole or in parts is prohibited. The prohibition shall only
