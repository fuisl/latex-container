\chapter{Organization Profile and Internship}
\label{ch:OrgProfile}
...
\begin{itemize}
    ...
    \item Documenting decisions, supported by evidence such as benchmarks, evaluation results, and operational metrics.
...
Technical priorities were shaped by practical constraints: fixed timeline (prioritized high-impact deliverables, disciplined scope control), shared infrastructure (required environment separation and conservative rollout), external AI dependencies (required cost budgets and retry policies), and data sensitivity (required strict access controls and logging redaction).

The following mitigations were applied:
