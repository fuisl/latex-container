...
From this experiment, it became clear that local serving was useful only in early exploration, which directly influenced the later decision to move toward managed serving.